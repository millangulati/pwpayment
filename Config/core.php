 ...
 * Commonly used over application.
 */
	include 'conf.php';
 ...
 *   should place the file for that class in src/Lib/Error. This class needs to implement a render method.
 ...
 *
 * To define a custom session handler, save it at /src/Model/Datasource/Session/<name>.php.
 * Make sure the class implements `CakeSessionHandlerInterface` and set Session.handler to <name>
 *
 * To use database sessions, run the src/Config/Schema/sessions.php schema using
 ...
 */
	Configure::write('Security.salt', 'ViNaYDYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mikUmAr');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '926607685930965745354249674968364519072');
 ...
 *
 * Note: 'default' and other application caches should be configured in src/Config/bootstrap.php.
