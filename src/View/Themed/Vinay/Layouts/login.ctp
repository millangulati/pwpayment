...
echo $this->Html->css(array('bootstrap.min', 'theme.min', (empty($theme) ? 'skin-red-velvet.min' : $theme), 'font-awesome.min', 'ionicons.min', 'newtheme/components-md.min', 'newtheme/login.min'));
...
echo $this->Html->tag('body', null, array('class' => 'login'));
...
<style>
	...
	background: #1adbd1 none repeat scroll 0 0;
    }
</style>
<?php
