...
echo $this->Html->tag('span', 'Retailer Payment Authentication', array('class' => 'caption-subject font-green-sharp bold uppercase'));
...
if (!empty($pendingRequestLists)) {
    ...
    $header = array("Branch", "Brand", "Date", "Remarks", "Deposit Date", "Retailer", "Mode", "Bank Name", "Branch Code", "Cheque No.", "Amount");
...
//            $("#msgDiv").html("Error in Response.Please refresh and try again");
    ...
    function authorize(payment_ser_no, statement_no) {
        ...
        if (conf) {
            var dataString = "serno=" + payment_ser_no + "&statement_no=" + statement_no + "&authcode=" + authcode + "&entered_rs=" + JSON.stringify(entered_rs) + "&requestType='retailer'&AuthVar=" + AuthVar;
    ...
    function revoke(payment_ser_no, statement_no) {
        ...
        if (conf) {
            var dataString = "srno=" + payment_ser_no + "&statement_no=" + statement_no + "&authcode=" + authcode + "&entered_rs=" + JSON.stringify(entered_rs) + "&requestType='retailer'&AuthVar=" + AuthVar;
